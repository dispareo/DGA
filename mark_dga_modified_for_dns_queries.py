...
#Adding in pause to manually enter DNS records
def pause():
...
#Changing the tlds to keep it as csc840 to just be easier to maintain,rather than creating 5 diff SOA's and DNS zones (rather than just A/PTR records)
tlds = ".csc840.lan"
list_of_domains=[]
